...
#             if threat_coords:
#                 near, confidence, threat_class, distance = is_threat_near_user(
...
#                     break  # stop after finding one valid nearby threat
...
# #     location = "Delhi"
# #     result = analyze_news_by_location(location)

# #     print("Threat Detected:", result["threat"])
# #     print("\n--- Articles Analyzed ---")
# #     for article in result["articles"]:
# #         print(f"Title: {article['title']}")
# #         print(f"Threat Label: {article['label']}")
# #         print(f"Confidence Score: {article['score']}")
# #         print(f"Entities: {article['entities']}")
# #         print(f"Distance (km): {article.get('distance_km')}")
# #         print("-" * 40)
